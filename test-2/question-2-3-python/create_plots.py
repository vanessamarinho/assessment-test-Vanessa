...
def plots(data):
    ...
    plt.savefig("price_variation_per_square_meter.png")
    ...
    plt.xlabel("Used area")
    plt.savefig("used_areaXprice.png")
    ...
    plt.ylabel("New price")
    plt.xlabel("Built area")
    plt.savefig("built_areaXprice.png")